...
@Table(name = "country", schema = "directory",
       uniqueConstraints = {@UniqueConstraint(name = "CountryTitleConstraint", columnNames = "title"),
                            @UniqueConstraint(name = "CountryDescriptionConstraint", columnNames = "description")})
