...
--changeset grisha:1
INSERT INTO signed.users (uuid, create_date, mail, nick, password, status, update_date)
...
--changeset grisha:2
INSERT INTO signed.roles (id, name)
VALUES ('1', 'ADMIN');
...
--changeset grisha:3
INSERT INTO signed.user_roles (user_uuid, role_id) VALUES ('76601d1d-eded-474e-8d3f-bdff9ea0c177', '1');
INSERT INTO signed.user_roles (user_uuid, role_id) VALUES ('84b25364-d220-42ae-b971-f1a4952aeef3', '2');
